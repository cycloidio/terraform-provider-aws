...
func defaultEndpoint(region string) (url.URL, error) {
	r := emrcontainers_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), emrcontainers_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListVirtualClusters(ctx, &emrcontainers_sdkv2.ListVirtualClustersInput{},
		func(opts *emrcontainers_sdkv2.Options) {
