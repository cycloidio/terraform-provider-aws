...
func defaultEndpoint(region string) (url.URL, error) {
	r := directconnect_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), directconnect_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeConnections(ctx, &directconnect_sdkv2.DescribeConnectionsInput{},
		func(opts *directconnect_sdkv2.Options) {
