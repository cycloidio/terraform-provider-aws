...
func defaultEndpoint(region string) (url.URL, error) {
	r := glue_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), glue_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListRegistries(ctx, &glue_sdkv2.ListRegistriesInput{},
		func(opts *glue_sdkv2.Options) {
