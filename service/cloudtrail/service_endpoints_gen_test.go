...
func defaultEndpoint(region string) (url.URL, error) {
	r := cloudtrail_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), cloudtrail_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListChannels(ctx, &cloudtrail_sdkv2.ListChannelsInput{},
		func(opts *cloudtrail_sdkv2.Options) {
