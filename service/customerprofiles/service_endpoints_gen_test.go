...
func defaultEndpoint(region string) (url.URL, error) {
	r := customerprofiles_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), customerprofiles_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDomains(ctx, &customerprofiles_sdkv2.ListDomainsInput{},
		func(opts *customerprofiles_sdkv2.Options) {
