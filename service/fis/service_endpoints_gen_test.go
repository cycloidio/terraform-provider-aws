...
func defaultEndpoint(region string) (url.URL, error) {
	r := fis_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), fis_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListExperiments(ctx, &fis_sdkv2.ListExperimentsInput{},
		func(opts *fis_sdkv2.Options) {
