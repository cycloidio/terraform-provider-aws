...
func defaultEndpoint(region string) (url.URL, error) {
	r := account_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), account_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListRegions(ctx, &account_sdkv2.ListRegionsInput{},
		func(opts *account_sdkv2.Options) {
