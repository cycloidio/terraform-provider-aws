...
func defaultEndpoint(region string) (url.URL, error) {
	r := codebuild_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), codebuild_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListBuildBatches(ctx, &codebuild_sdkv2.ListBuildBatchesInput{},
		func(opts *codebuild_sdkv2.Options) {
