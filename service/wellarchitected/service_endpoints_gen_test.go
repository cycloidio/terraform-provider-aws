...
func defaultEndpoint(region string) (url.URL, error) {
	r := wellarchitected_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), wellarchitected_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListProfiles(ctx, &wellarchitected_sdkv2.ListProfilesInput{},
		func(opts *wellarchitected_sdkv2.Options) {
