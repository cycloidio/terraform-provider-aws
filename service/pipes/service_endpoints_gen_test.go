...
func defaultEndpoint(region string) (url.URL, error) {
	r := pipes_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), pipes_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListPipes(ctx, &pipes_sdkv2.ListPipesInput{},
		func(opts *pipes_sdkv2.Options) {
