...
func defaultEndpoint(region string) (url.URL, error) {
	r := groundstation_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), groundstation_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListConfigs(ctx, &groundstation_sdkv2.ListConfigsInput{},
		func(opts *groundstation_sdkv2.Options) {
