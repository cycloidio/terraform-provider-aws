...
func defaultEndpoint(region string) (url.URL, error) {
	r := devicefarm_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), devicefarm_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDeviceInstances(ctx, &devicefarm_sdkv2.ListDeviceInstancesInput{},
		func(opts *devicefarm_sdkv2.Options) {
