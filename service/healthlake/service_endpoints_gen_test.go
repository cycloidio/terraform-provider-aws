...
func defaultEndpoint(region string) (url.URL, error) {
	r := healthlake_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), healthlake_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListFHIRDatastores(ctx, &healthlake_sdkv2.ListFHIRDatastoresInput{},
		func(opts *healthlake_sdkv2.Options) {
