...
func defaultEndpoint(region string) (url.URL, error) {
	r := chatbot_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), chatbot_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.GetAccountPreferences(ctx, &chatbot_sdkv2.GetAccountPreferencesInput{},
		func(opts *chatbot_sdkv2.Options) {
