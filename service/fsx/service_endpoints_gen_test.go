...
func defaultEndpoint(region string) (url.URL, error) {
	r := fsx_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), fsx_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeFileSystems(ctx, &fsx_sdkv2.DescribeFileSystemsInput{},
		func(opts *fsx_sdkv2.Options) {
