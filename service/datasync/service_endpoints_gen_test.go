...
func defaultEndpoint(region string) (url.URL, error) {
	r := datasync_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), datasync_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListAgents(ctx, &datasync_sdkv2.ListAgentsInput{},
		func(opts *datasync_sdkv2.Options) {
