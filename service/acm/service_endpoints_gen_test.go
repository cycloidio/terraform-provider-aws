...
func defaultEndpoint(region string) (url.URL, error) {
	r := acm_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), acm_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListCertificates(ctx, &acm_sdkv2.ListCertificatesInput{},
		func(opts *acm_sdkv2.Options) {
