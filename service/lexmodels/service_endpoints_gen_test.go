...
func defaultEndpoint(region string) (url.URL, error) {
	r := lexmodelbuildingservice_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), lexmodelbuildingservice_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.GetBots(ctx, &lexmodelbuildingservice_sdkv2.GetBotsInput{},
		func(opts *lexmodelbuildingservice_sdkv2.Options) {
