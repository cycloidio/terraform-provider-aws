...
func defaultEndpoint(region string) (url.URL, error) {
	r := dataexchange_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), dataexchange_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDataSets(ctx, &dataexchange_sdkv2.ListDataSetsInput{},
		func(opts *dataexchange_sdkv2.Options) {
