...
func defaultEndpoint(region string) (url.URL, error) {
	r := qldb_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), qldb_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListLedgers(ctx, &qldb_sdkv2.ListLedgersInput{},
		func(opts *qldb_sdkv2.Options) {
