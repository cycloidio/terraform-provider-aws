...
func defaultEndpoint(region string) (url.URL, error) {
	r := sfn_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), sfn_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListActivities(ctx, &sfn_sdkv2.ListActivitiesInput{},
		func(opts *sfn_sdkv2.Options) {
