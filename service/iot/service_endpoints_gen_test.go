...
func defaultEndpoint(region string) (url.URL, error) {
	r := iot_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), iot_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeDefaultAuthorizer(ctx, &iot_sdkv2.DescribeDefaultAuthorizerInput{},
		func(opts *iot_sdkv2.Options) {
