...
func defaultEndpoint(region string) (url.URL, error) {
	r := configservice_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), configservice_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListStoredQueries(ctx, &configservice_sdkv2.ListStoredQueriesInput{},
		func(opts *configservice_sdkv2.Options) {
