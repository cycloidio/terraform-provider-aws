...
func defaultEndpoint(region string) (url.URL, error) {
	r := connectcases_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), connectcases_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDomains(ctx, &connectcases_sdkv2.ListDomainsInput{},
		func(opts *connectcases_sdkv2.Options) {
