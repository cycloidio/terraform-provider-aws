...
func defaultEndpoint(region string) (url.URL, error) {
	r := mediaconnect_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), mediaconnect_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListBridges(ctx, &mediaconnect_sdkv2.ListBridgesInput{},
		func(opts *mediaconnect_sdkv2.Options) {
