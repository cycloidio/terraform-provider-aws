...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*applicationinsights_sdkv2.Client, error) {
	cfg := *(config["aws_sdkv2_config"].(*aws_sdkv2.Config))

	return applicationinsights_sdkv2.NewFromConfig(cfg,
		applicationinsights_sdkv2.WithEndpointResolverV2(newEndpointResolverSDKv2()),
