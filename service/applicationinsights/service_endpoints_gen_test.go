...
func defaultEndpoint(region string) (url.URL, error) {
	r := applicationinsights_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), applicationinsights_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.CreateApplication(ctx, &applicationinsights_sdkv2.CreateApplicationInput{},
		func(opts *applicationinsights_sdkv2.Options) {
