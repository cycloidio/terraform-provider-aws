...
func defaultEndpoint(region string) (url.URL, error) {
	r := networkmanager_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), networkmanager_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListCoreNetworks(ctx, &networkmanager_sdkv2.ListCoreNetworksInput{},
		func(opts *networkmanager_sdkv2.Options) {
