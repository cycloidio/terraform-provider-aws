...
func ListTags(ctx context.Context, conn securityhubiface.SecurityHubAPI, identifier string) (tftags.KeyValueTags, error) {
...
func (p *servicePackage) ListTags(ctx context.Context, meta any, identifier string) error {
	tags, err := ListTags(ctx, meta.(*conns.AWSClient).SecurityHubConn(), identifier)
...
// KeyValueTags creates KeyValueTags from securityhub service tags.
...
func (p *servicePackage) UpdateTags(ctx context.Context, meta any, identifier string, oldTags, newTags any) error {
	return UpdateTags(ctx, meta.(*conns.AWSClient).SecurityHubConn(), identifier, oldTags, newTags)
}
