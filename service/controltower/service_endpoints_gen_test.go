...
func defaultEndpoint(region string) (url.URL, error) {
	r := controltower_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), controltower_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListLandingZones(ctx, &controltower_sdkv2.ListLandingZonesInput{},
		func(opts *controltower_sdkv2.Options) {
