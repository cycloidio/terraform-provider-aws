...
func defaultEndpoint(region string) (url.URL, error) {
	r := cloudwatch_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), cloudwatch_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDashboards(ctx, &cloudwatch_sdkv2.ListDashboardsInput{},
		func(opts *cloudwatch_sdkv2.Options) {
