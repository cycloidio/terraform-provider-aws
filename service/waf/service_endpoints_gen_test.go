...
func defaultEndpoint(region string) (url.URL, error) {
	r := waf_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), waf_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListRules(ctx, &waf_sdkv2.ListRulesInput{},
		func(opts *waf_sdkv2.Options) {
