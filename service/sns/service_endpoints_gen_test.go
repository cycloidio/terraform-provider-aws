...
func defaultEndpoint(region string) (url.URL, error) {
	r := sns_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), sns_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListSubscriptions(ctx, &sns_sdkv2.ListSubscriptionsInput{},
		func(opts *sns_sdkv2.Options) {
