...
func defaultEndpoint(region string) (url.URL, error) {
	r := mediapackage_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), mediapackage_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListChannels(ctx, &mediapackage_sdkv2.ListChannelsInput{},
		func(opts *mediapackage_sdkv2.Options) {
