...
func defaultEndpoint(region string) (url.URL, error) {
	r := outposts_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), outposts_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListSites(ctx, &outposts_sdkv2.ListSitesInput{},
		func(opts *outposts_sdkv2.Options) {
