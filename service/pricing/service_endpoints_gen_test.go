...
func defaultEndpoint(region string) (url.URL, error) {
	r := pricing_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), pricing_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeServices(ctx, &pricing_sdkv2.DescribeServicesInput{},
		func(opts *pricing_sdkv2.Options) {
