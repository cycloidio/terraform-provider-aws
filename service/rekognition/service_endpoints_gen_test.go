...
func defaultEndpoint(region string) (url.URL, error) {
	r := rekognition_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), rekognition_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListCollections(ctx, &rekognition_sdkv2.ListCollectionsInput{},
		func(opts *rekognition_sdkv2.Options) {
