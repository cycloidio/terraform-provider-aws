...
func defaultEndpoint(region string) (url.URL, error) {
	r := ses_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ses_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListIdentities(ctx, &ses_sdkv2.ListIdentitiesInput{},
		func(opts *ses_sdkv2.Options) {
