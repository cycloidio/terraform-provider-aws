...
func defaultEndpoint(region string) (url.URL, error) {
	r := codecommit_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), codecommit_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListRepositories(ctx, &codecommit_sdkv2.ListRepositoriesInput{},
		func(opts *codecommit_sdkv2.Options) {
