...
func defaultEndpoint(region string) (url.URL, error) {
	r := chime_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), chime_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListAccounts(ctx, &chime_sdkv2.ListAccountsInput{},
		func(opts *chime_sdkv2.Options) {
