...
func defaultEndpoint(region string) (url.URL, error) {
	r := storagegateway_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), storagegateway_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListGateways(ctx, &storagegateway_sdkv2.ListGatewaysInput{},
		func(opts *storagegateway_sdkv2.Options) {
