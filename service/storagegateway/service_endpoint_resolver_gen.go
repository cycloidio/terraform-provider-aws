...
var _ storagegateway_sdkv2.EndpointResolverV2 = resolverSDKv2{}

type resolverSDKv2 struct {
	defaultResolver storagegateway_sdkv2.EndpointResolverV2
}

func newEndpointResolverSDKv2() resolverSDKv2 {
	return resolverSDKv2{
		defaultResolver: storagegateway_sdkv2.NewDefaultEndpointResolverV2(),
	}
}

func (r resolverSDKv2) ResolveEndpoint(ctx context.Context, params storagegateway_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
...
func withBaseEndpoint(endpoint string) func(*storagegateway_sdkv2.Options) {
	return func(o *storagegateway_sdkv2.Options) {
		if endpoint != "" {
