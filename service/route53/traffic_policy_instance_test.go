...
import (
	...
	tfroute53 "github.com/hashicorp/terraform-provider-aws/service/route53"
...
func testAccCheckRoute53TrafficPolicyInstanceExists(n string, v *route53.TrafficPolicyInstance) resource.TestCheckFunc {
