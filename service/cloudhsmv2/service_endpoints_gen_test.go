...
func defaultEndpoint(region string) (url.URL, error) {
	r := cloudhsmv2_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), cloudhsmv2_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeClusters(ctx, &cloudhsmv2_sdkv2.DescribeClustersInput{},
		func(opts *cloudhsmv2_sdkv2.Options) {
