...
func defaultEndpoint(region string) (url.URL, error) {
	r := servicequotas_sdkv2.NewDefaultEndpointResolverV2()
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListServices(ctx, &servicequotas_sdkv2.ListServicesInput{},
		func(opts *servicequotas_sdkv2.Options) {
