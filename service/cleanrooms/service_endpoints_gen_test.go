...
func defaultEndpoint(region string) (url.URL, error) {
	r := cleanrooms_sdkv2.NewDefaultEndpointResolverV2()
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListCollaborations(ctx, &cleanrooms_sdkv2.ListCollaborationsInput{},
		func(opts *cleanrooms_sdkv2.Options) {
