...
func defaultEndpoint(region string) (url.URL, error) {
	r := polly_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), polly_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListLexicons(ctx, &polly_sdkv2.ListLexiconsInput{},
		func(opts *polly_sdkv2.Options) {
