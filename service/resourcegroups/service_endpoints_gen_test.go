...
func defaultEndpoint(region string) (url.URL, error) {
	r := resourcegroups_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), resourcegroups_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListGroups(ctx, &resourcegroups_sdkv2.ListGroupsInput{},
		func(opts *resourcegroups_sdkv2.Options) {
