...
func defaultEndpoint(region string) (url.URL, error) {
	r := costoptimizationhub_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), costoptimizationhub_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.GetPreferences(ctx, &costoptimizationhub_sdkv2.GetPreferencesInput{},
		func(opts *costoptimizationhub_sdkv2.Options) {
