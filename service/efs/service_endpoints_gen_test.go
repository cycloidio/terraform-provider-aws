...
func defaultEndpoint(region string) (url.URL, error) {
	r := efs_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), efs_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeFileSystems(ctx, &efs_sdkv2.DescribeFileSystemsInput{},
		func(opts *efs_sdkv2.Options) {
