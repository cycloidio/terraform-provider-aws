...
func defaultEndpoint(region string) (url.URL, error) {
	r := ssmsap_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ssmsap_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListApplications(ctx, &ssmsap_sdkv2.ListApplicationsInput{},
		func(opts *ssmsap_sdkv2.Options) {
