...
func defaultEndpoint(region string) (url.URL, error) {
	r := identitystore_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), identitystore_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListUsers(ctx, &identitystore_sdkv2.ListUsersInput{
		IdentityStoreId: aws_sdkv2.String("d-1234567890"),
	},
		func(opts *identitystore_sdkv2.Options) {
