...
func defaultEndpoint(region string) (url.URL, error) {
	r := comprehend_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), comprehend_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDocumentClassifiers(ctx, &comprehend_sdkv2.ListDocumentClassifiersInput{},
		func(opts *comprehend_sdkv2.Options) {
