...
func defaultEndpoint(region string) (url.URL, error) {
	r := mediastore_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), mediastore_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListContainers(ctx, &mediastore_sdkv2.ListContainersInput{},
		func(opts *mediastore_sdkv2.Options) {
