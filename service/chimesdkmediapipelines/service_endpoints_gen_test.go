...
func defaultEndpoint(region string) (url.URL, error) {
	r := chimesdkmediapipelines_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), chimesdkmediapipelines_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListMediaPipelines(ctx, &chimesdkmediapipelines_sdkv2.ListMediaPipelinesInput{},
		func(opts *chimesdkmediapipelines_sdkv2.Options) {
