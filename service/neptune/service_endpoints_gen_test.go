...
func defaultEndpoint(region string) (url.URL, error) {
	r := neptune_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), neptune_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeDBClusters(ctx, &neptune_sdkv2.DescribeDBClustersInput{},
		func(opts *neptune_sdkv2.Options) {
