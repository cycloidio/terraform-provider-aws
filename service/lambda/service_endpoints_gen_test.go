...
func defaultEndpoint(region string) (url.URL, error) {
	r := lambda_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), lambda_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListFunctions(ctx, &lambda_sdkv2.ListFunctionsInput{},
		func(opts *lambda_sdkv2.Options) {
