...
func defaultEndpoint(region string) (url.URL, error) {
	r := firehose_sdkv2.NewDefaultEndpointResolverV2()
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDeliveryStreams(ctx, &firehose_sdkv2.ListDeliveryStreamsInput{},
		func(opts *firehose_sdkv2.Options) {
