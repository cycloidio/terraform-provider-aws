...
func defaultEndpoint(region string) (url.URL, error) {
	r := eks_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), eks_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListClusters(ctx, &eks_sdkv2.ListClustersInput{},
		func(opts *eks_sdkv2.Options) {
