...
func defaultEndpoint(region string) (url.URL, error) {
	r := ecr_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ecr_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeRepositories(ctx, &ecr_sdkv2.DescribeRepositoriesInput{},
		func(opts *ecr_sdkv2.Options) {
