...
func defaultEndpoint(region string) (url.URL, error) {
	r := apigatewayv2_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), apigatewayv2_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.GetApis(ctx, &apigatewayv2_sdkv2.GetApisInput{},
		func(opts *apigatewayv2_sdkv2.Options) {
