...
func defaultEndpoint(region string) (url.URL, error) {
	r := appmesh_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), appmesh_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListMeshes(ctx, &appmesh_sdkv2.ListMeshesInput{},
		func(opts *appmesh_sdkv2.Options) {
