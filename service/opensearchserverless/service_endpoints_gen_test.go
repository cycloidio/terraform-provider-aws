...
func defaultEndpoint(region string) (url.URL, error) {
	r := opensearchserverless_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), opensearchserverless_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListCollections(ctx, &opensearchserverless_sdkv2.ListCollectionsInput{},
		func(opts *opensearchserverless_sdkv2.Options) {
