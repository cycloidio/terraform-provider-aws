...
func defaultEndpoint(region string) (url.URL, error) {
	r := appfabric_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), appfabric_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListAppBundles(ctx, &appfabric_sdkv2.ListAppBundlesInput{},
		func(opts *appfabric_sdkv2.Options) {
