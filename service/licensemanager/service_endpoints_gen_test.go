...
func defaultEndpoint(region string) (url.URL, error) {
	r := licensemanager_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), licensemanager_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListLicenseConfigurations(ctx, &licensemanager_sdkv2.ListLicenseConfigurationsInput{},
		func(opts *licensemanager_sdkv2.Options) {
