...
func defaultEndpoint(region string) (url.URL, error) {
	r := apprunner_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), apprunner_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListConnections(ctx, &apprunner_sdkv2.ListConnectionsInput{},
		func(opts *apprunner_sdkv2.Options) {
