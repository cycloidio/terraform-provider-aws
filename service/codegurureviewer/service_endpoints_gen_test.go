...
func defaultEndpoint(region string) (url.URL, error) {
	r := codegurureviewer_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), codegurureviewer_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListCodeReviews(ctx, &codegurureviewer_sdkv2.ListCodeReviewsInput{
		Type: awstypes.TypePullRequest,
	},
		func(opts *codegurureviewer_sdkv2.Options) {
