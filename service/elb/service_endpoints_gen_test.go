...
func defaultEndpoint(region string) (url.URL, error) {
	r := elasticloadbalancing_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), elasticloadbalancing_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeLoadBalancers(ctx, &elasticloadbalancing_sdkv2.DescribeLoadBalancersInput{},
		func(opts *elasticloadbalancing_sdkv2.Options) {
