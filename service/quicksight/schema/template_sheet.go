...
import (
	...
	"github.com/hashicorp/terraform-provider-aws/sdkv2/types/nullable"
				...
				"default_new_sheet_configuration": { // https://docs.aws.amazon.com/quicksight/latest/APIReference/API_DefaultNewSheetConfiguration.html
					...
					Elem: &schema.Resource{
						Schema: map[string]*schema.Schema{
							...
							"sheet_content_type":               stringSchema(false, enum.Validate[awstypes.SheetContentType]()),
						},
					},
				},
			},
	...
	return &schema.Schema{
		...
		Elem: &schema.Resource{
			Schema: map[string]*schema.Schema{
				...
				"paper_orientation": stringSchema(false, enum.Validate[awstypes.PaperOrientation]()),
				"paper_size":        stringSchema(false, enum.Validate[awstypes.PaperSize]()),
			},
		},
	}
}
				...
				"elements": { // https://docs.aws.amazon.com/quicksight/latest/APIReference/API_GridLayoutElement.html
					...
					Elem: &schema.Resource{
						Schema: map[string]*schema.Schema{
							...
							"element_id":   idSchema(),
							"element_type": stringSchema(true, enum.Validate[awstypes.LayoutElementType]()),
							"row_span": {
								Type:         schema.TypeInt,
								Required:     true,
