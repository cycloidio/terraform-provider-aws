...
func defaultEndpoint(region string) (url.URL, error) {
	r := detective_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), detective_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListGraphs(ctx, &detective_sdkv2.ListGraphsInput{},
		func(opts *detective_sdkv2.Options) {
