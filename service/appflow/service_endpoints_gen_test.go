...
func defaultEndpoint(region string) (url.URL, error) {
	r := appflow_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), appflow_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListFlows(ctx, &appflow_sdkv2.ListFlowsInput{},
		func(opts *appflow_sdkv2.Options) {
