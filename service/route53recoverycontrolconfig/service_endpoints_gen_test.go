...
func defaultEndpoint(region string) (url.URL, error) {
	r := route53recoverycontrolconfig_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), route53recoverycontrolconfig_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListClusters(ctx, &route53recoverycontrolconfig_sdkv2.ListClustersInput{},
		func(opts *route53recoverycontrolconfig_sdkv2.Options) {
