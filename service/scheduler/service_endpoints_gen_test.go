...
func defaultEndpoint(region string) (url.URL, error) {
	r := scheduler_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), scheduler_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListSchedules(ctx, &scheduler_sdkv2.ListSchedulesInput{},
		func(opts *scheduler_sdkv2.Options) {
