...
func defaultEndpoint(region string) (url.URL, error) {
	r := cloud9_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), cloud9_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListEnvironments(ctx, &cloud9_sdkv2.ListEnvironmentsInput{},
		func(opts *cloud9_sdkv2.Options) {
