...
func defaultEndpoint(region string) (url.URL, error) {
	r := m2_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), m2_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListApplications(ctx, &m2_sdkv2.ListApplicationsInput{},
		func(opts *m2_sdkv2.Options) {
