...
func defaultEndpoint(region string) (url.URL, error) {
	r := verifiedpermissions_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), verifiedpermissions_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListPolicyStores(ctx, &verifiedpermissions_sdkv2.ListPolicyStoresInput{},
		func(opts *verifiedpermissions_sdkv2.Options) {
