...
func defaultEndpoint(region string) (url.URL, error) {
	r := appintegrations_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), appintegrations_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListApplications(ctx, &appintegrations_sdkv2.ListApplicationsInput{},
		func(opts *appintegrations_sdkv2.Options) {
