...
func defaultEndpoint(region string) (url.URL, error) {
	r := workspaces_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), workspaces_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeWorkspaces(ctx, &workspaces_sdkv2.DescribeWorkspacesInput{},
		func(opts *workspaces_sdkv2.Options) {
