...
func defaultEndpoint(region string) (url.URL, error) {
	r := codeguruprofiler_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), codeguruprofiler_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListProfilingGroups(ctx, &codeguruprofiler_sdkv2.ListProfilingGroupsInput{},
		func(opts *codeguruprofiler_sdkv2.Options) {
