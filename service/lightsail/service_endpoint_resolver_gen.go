...
var _ lightsail_sdkv2.EndpointResolverV2 = resolverSDKv2{}

type resolverSDKv2 struct {
	defaultResolver lightsail_sdkv2.EndpointResolverV2
}

func newEndpointResolverSDKv2() resolverSDKv2 {
	return resolverSDKv2{
		defaultResolver: lightsail_sdkv2.NewDefaultEndpointResolverV2(),
	}
}

func (r resolverSDKv2) ResolveEndpoint(ctx context.Context, params lightsail_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
...
func withBaseEndpoint(endpoint string) func(*lightsail_sdkv2.Options) {
	return func(o *lightsail_sdkv2.Options) {
		if endpoint != "" {
