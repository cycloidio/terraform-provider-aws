...
func defaultEndpoint(region string) (url.URL, error) {
	r := lightsail_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), lightsail_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.GetInstances(ctx, &lightsail_sdkv2.GetInstancesInput{},
		func(opts *lightsail_sdkv2.Options) {
