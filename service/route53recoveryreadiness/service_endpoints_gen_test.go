...
func defaultEndpoint(region string) (url.URL, error) {
	r := route53recoveryreadiness_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), route53recoveryreadiness_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListCells(ctx, &route53recoveryreadiness_sdkv2.ListCellsInput{},
		func(opts *route53recoveryreadiness_sdkv2.Options) {
