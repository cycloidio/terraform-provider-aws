...
func defaultEndpoint(region string) (url.URL, error) {
	r := keyspaces_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), keyspaces_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListKeyspaces(ctx, &keyspaces_sdkv2.ListKeyspacesInput{},
		func(opts *keyspaces_sdkv2.Options) {
