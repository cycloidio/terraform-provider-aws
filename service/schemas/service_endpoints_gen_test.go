...
func defaultEndpoint(region string) (url.URL, error) {
	r := schemas_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), schemas_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListRegistries(ctx, &schemas_sdkv2.ListRegistriesInput{},
		func(opts *schemas_sdkv2.Options) {
