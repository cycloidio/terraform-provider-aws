...
func defaultEndpoint(region string) (url.URL, error) {
	r := bedrock_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), bedrock_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListFoundationModels(ctx, &bedrock_sdkv2.ListFoundationModelsInput{},
		func(opts *bedrock_sdkv2.Options) {
