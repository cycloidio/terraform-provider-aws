...
func defaultEndpoint(region string) (url.URL, error) {
	r := elasticsearchservice_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), elasticsearchservice_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDomainNames(ctx, &elasticsearchservice_sdkv2.ListDomainNamesInput{},
		func(opts *elasticsearchservice_sdkv2.Options) {
