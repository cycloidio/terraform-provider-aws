...
func defaultEndpoint(region string) (url.URL, error) {
	r := launchwizard_sdkv2.NewDefaultEndpointResolverV2()
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListWorkloads(ctx, &launchwizard_sdkv2.ListWorkloadsInput{},
		func(opts *launchwizard_sdkv2.Options) {
