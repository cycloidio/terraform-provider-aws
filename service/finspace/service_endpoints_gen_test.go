...
func defaultEndpoint(region string) (url.URL, error) {
	r := finspace_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), finspace_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListEnvironments(ctx, &finspace_sdkv2.ListEnvironmentsInput{},
		func(opts *finspace_sdkv2.Options) {
