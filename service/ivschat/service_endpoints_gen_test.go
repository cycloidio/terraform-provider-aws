...
func defaultEndpoint(region string) (url.URL, error) {
	r := ivschat_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ivschat_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListRooms(ctx, &ivschat_sdkv2.ListRoomsInput{},
		func(opts *ivschat_sdkv2.Options) {
