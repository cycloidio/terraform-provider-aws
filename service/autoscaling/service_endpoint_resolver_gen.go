...
var _ autoscaling_sdkv2.EndpointResolverV2 = resolverSDKv2{}

type resolverSDKv2 struct {
	defaultResolver autoscaling_sdkv2.EndpointResolverV2
}

func newEndpointResolverSDKv2() resolverSDKv2 {
	return resolverSDKv2{
		defaultResolver: autoscaling_sdkv2.NewDefaultEndpointResolverV2(),
	}
}

func (r resolverSDKv2) ResolveEndpoint(ctx context.Context, params autoscaling_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
...
func withBaseEndpoint(endpoint string) func(*autoscaling_sdkv2.Options) {
	return func(o *autoscaling_sdkv2.Options) {
		if endpoint != "" {
