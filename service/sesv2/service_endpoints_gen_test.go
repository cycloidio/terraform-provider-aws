...
func defaultEndpoint(region string) (url.URL, error) {
	r := sesv2_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), sesv2_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListContactLists(ctx, &sesv2_sdkv2.ListContactListsInput{},
		func(opts *sesv2_sdkv2.Options) {
