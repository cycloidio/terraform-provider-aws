...
func defaultEndpoint(region string) (url.URL, error) {
	r := elasticache_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), elasticache_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeCacheClusters(ctx, &elasticache_sdkv2.DescribeCacheClustersInput{},
		func(opts *elasticache_sdkv2.Options) {
