...
func defaultEndpoint(region string) (url.URL, error) {
	r := dax_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), dax_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeClusters(ctx, &dax_sdkv2.DescribeClustersInput{},
		func(opts *dax_sdkv2.Options) {
