...
func (p *servicePackage) ListTags(ctx context.Context, meta any, identifier string) error {
	tags, err := ListTags(ctx, meta.(*conns.AWSClient).DAXConn(), identifier)
...
func KeyValueTags(ctx context.Context, tags []*dax.Tag) tftags.KeyValueTags {
...
func GetTagsIn(ctx context.Context) []*dax.Tag {
	if inContext, ok := tftags.FromContext(ctx); ok {
...
func SetTagsOut(ctx context.Context, tags []*dax.Tag) {
	if inContext, ok := tftags.FromContext(ctx); ok {
...
func (p *servicePackage) UpdateTags(ctx context.Context, meta any, identifier string, oldTags, newTags any) error {
	return UpdateTags(ctx, meta.(*conns.AWSClient).DAXConn(), identifier, oldTags, newTags)
}
