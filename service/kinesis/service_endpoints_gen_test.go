...
func defaultEndpoint(region string) (url.URL, error) {
	r := kinesis_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), kinesis_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListStreams(ctx, &kinesis_sdkv2.ListStreamsInput{},
		func(opts *kinesis_sdkv2.Options) {
