...
const (
	packageName = "dsql"
	awsEnvVar   = "AWS_ENDPOINT_URL_DSQL"
...
func defaultEndpoint(region string) (url.URL, error) {
	r := dsql.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), dsql.EndpointParameters{
